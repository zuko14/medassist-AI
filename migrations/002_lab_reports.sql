...
CREATE POLICY "Full access for service_role only" ON lab_reports FOR ALL TO service_role USING (true);
...
CREATE POLICY "Full access for service_role only" ON prescriptions FOR ALL TO service_role USING (true);
