...
- [x] **Step 1: Write the failing test** — create `tests/test_specialty_ai.py`:
...
- [x] **Step 3: Check for name clashes, then add `import re`**
...
- [x] **Step 4: Append to the end of `app/services/ai_engine.py`** (exact content):
